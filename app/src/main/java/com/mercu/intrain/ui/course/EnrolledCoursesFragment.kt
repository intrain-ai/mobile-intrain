...
class EnrolledCoursesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        courseRepository = (activity as CourseActivity).courseRepository
        
        // Initialize adapter with enrolled courses
        val activity = requireActivity() as CourseActivity
        courseAdapter = CourseAdapter(
            activity.enrolledCourses.toMutableList(),
            activity.courseDetails,
            activity.courseRepository,
            viewLifecycleOwner
        )
